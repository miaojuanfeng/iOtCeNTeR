                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control select2" name="operationAuthority">
                                                <option value="1" <#if "${theme.operationAuthority!}"=="1">selected</#if> >发布</option>
                                                <option value="2" <#if "${theme.operationAuthority!}"=="2">selected</#if> >订阅</option>
                                                <option value="3" <#if "${theme.operationAuthority!}"=="3">selected</#if> >发布和订阅</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
