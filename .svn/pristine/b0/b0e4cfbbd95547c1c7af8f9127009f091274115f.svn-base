...
@Slf4j
@Component
public class NettySSLClient implements ApplicationContextAware {

    @Autowired
    private static NettySSLClientInitializer nettySSLClientInitializer;
...
//    private static final String jksPath = "C:\\Users\\k\\Desktop\\SHA256withRSA_iot.krtyun.com.jks";
    ...
    public static void initBootstrap() {
        try {
            ...
            nettySSLClientInitializer.setSslContext(sslContext);

            group = new NioEventLoopGroup();
            bootstrap = new Bootstrap();
            bootstrap.group(group).channel(NioSocketChannel.class);
            bootstrap.handler(nettySSLClientInitializer);
    ...
    public static void initChannel() {
        ...
        try {
            channel = bootstrap.connect(CommonConst.HOST, CommonConst.PORT_SSL).sync().channel();
   ...
   @Override
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        if( nettySSLClientInitializer == null ){
            nettySSLClientInitializer = applicationContext.getBean(NettySSLClientInitializer.class);
        }
        //initChannel();
    }
